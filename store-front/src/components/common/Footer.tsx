...
const Footer: React.FC = () => {
    ...
    const handleSubscribe = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage = (error as { response?: { data?: { message?: string } } })?.response?.data?.message || 'Subscription failed.';
            ...
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul className="space-y-4 font-light text-stone-600">
                        <li><Link href="/shop" className="hover:text-ruvera-gold transition-colors">New Arrivals</Link></li>
                        <li><Link href="/shop" className="hover:text-ruvera-gold transition-colors">Men</Link></li>
                        <li><Link href="/shop" className="hover:text-ruvera-gold transition-colors">Women</Link></li>
                        <li><Link href="/shop" className="hover:text-ruvera-gold transition-colors">Accessories</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4 font-light text-stone-600">
                        ...
                        <li><Link href="/orders" className="hover:text-ruvera-gold transition-colors">My Orders</Link></li>
                        <li><Link href="/shipping" className="hover:text-ruvera-gold transition-colors">Shipping & Returns</Link></li>
                        <li><Link href="/about" className="hover:text-ruvera-gold transition-colors">About Us</Link></li>
                        <li><Link href="/faq" className="hover:text-ruvera-gold transition-colors">FAQ</Link></li>
                        <li><Link href="/contact" className="hover:text-ruvera-gold transition-colors">Contact Concierge</Link></li>
                    </ul>
                </div>
