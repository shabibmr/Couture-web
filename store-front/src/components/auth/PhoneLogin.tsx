...
const PhoneLogin: React.FC<PhoneLoginProps> = ({ onBack, onSuccess, onUserTypeIdentified }) => {
    ...
    useEffect(() => {
        ...
        if (!recaptchaVerifierRef.current) {
            try {
                ...
                logger.error('[PhoneLogin] Failed to initialize reCAPTCHA', { error: err });
            }
        }
    ...
    const handleSendOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (checkResponse.ok) {
                ...
                logger.info('[PhoneLogin] User status determined', { status: checkData.exists ? 'Returning user' : 'New user' });
            } else {
            ...
            logger.error('[PhoneLogin] Failed to send OTP', { error: err });
    ...
    const handleVerifyOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            logger.error('[PhoneLogin] Failed to verify OTP', { error: err });
    ...
    const handleProfileSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            logger.error('[PhoneLogin] Failed to complete profile', { error: err });
