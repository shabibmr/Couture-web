...
export default function UserProfilePage() {
    ...
    // Profile editing state - initialize from user prop to avoid setState in effect
    ...
    // Use ref for reCAPTCHA to avoid setState in effect
    ...
    // Initialize reCAPTCHA on mount (runs once) - using ref to avoid setState in effect
    useEffect(() => {
        ...
        try {
            ...
            logger.error('reCAPTCHA init error', { err });
        }
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                {isEditingProfile ? (
                                    ...
                                    <p className="text-midnight">{user?.phone || 'Not set'}</p>
                                )}
                            </div>
